      ...
      <div className="w-full max-w-md z-10 px-4">
        ...
        <Card className="p-8 border border-surface-border shadow-2xl shadow-primary/10 animate-fade-in-up backdrop-blur-xl bg-background-card/80" style={{animationDelay: '0.1s'}}>
          <div className="text-center mb-8">
             <h2 className="text-2xl font-bold text-white font-display">{t('signin.title')}</h2>
             <p className="text-text-secondary text-sm mt-2">Welcome back to your workspace.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                    <span className="px-2 bg-[#131520] text-text-secondary rounded">Or continue with</span>
                </div>
            </div>
          ...
          <p className="mt-8 text-sm text-center text-text-secondary">
            {t('signin.no_account')}{' '}
            <Link to="/signup" className="font-medium text-primary hover:text-primary-hover hover:underline transition-colors">
              Create Account
            </Link>
          </p>
        </Card>
